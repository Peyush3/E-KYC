...
def main_content(image_file, face_image_file, conn,option):
    if image_file is not None:
        ...
        if face_image is not None:
            ...
            face_image_path1 = save_image(face_image, "face_image.jpg", path="data")
            ...
            if is_face_verified:
                ...
                if records.shape[0] > 0:
                    ...
                    st.write(records)
                is_duplicate = check_duplicacy(text_info, conn)
                if is_duplicate:
...
def main():
    ...
    if image_file is not None:
        ...
        main_content(image_file, face_image_file, conn,option)
